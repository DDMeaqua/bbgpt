  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div class="grid gap-8 xl:grid-cols-3 xl:gap-10">
          ...
          <div class="flex flex-col p-6 mx-auto max-w-xl text-center bg-white rounded-lg border border-gray-200 shadow xl:max-w-lg xl:p-8">
              ...
              <a href="#" class="text-white bg-gray-900 hover:bg-gray-700 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center my-8">Get started</a>
              <!-- List -->
          ...
          <div class="flex flex-col p-6 mx-auto max-w-xl text-center bg-white rounded-lg border shadow xl:max-w-lg border-primary-600 xl:p-8 border-purple-600">
              ...
              <a href="#" class="text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center my-8 bg-purple-600 hover:bg-purple-500">Get started</a>
              <!-- List -->
              <ul role="list" class="space-y-4 text-left text-gray-900">
                  <li class="flex items-center space-x-3">
                      <!-- Icon -->
